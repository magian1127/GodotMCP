...
3. Alt-tab to the editor (triggers a filesystem scan) or call `discover_tools(refresh_extensions:true)`.
...
`push_warning()` with install instructions (search "Godot MCP Unified" in the
